...
1. **Existence check**: Does the cited work exist? Verify against:
   - PubChem, ChemRxiv, ACS Publications, Google Scholar, and SciFinder
...
Load convention locks from .gcd/conventions.json.
...
Spawn gcd-referee with the manuscript. The referee runs 5 independent review perspectives:
...
#### 4f. Experimental Reproducibility Review
- Are synthetic procedures detailed enough to reproduce?
- Are characterization data (NMR, MS, IR) complete and consistent?
- Are yields realistic and properly calculated?
