...
Run diagnostic checks on the GCD project and optionally fix issues.

### Checks

1. **Required files**: .gcd/ directory exists, STATE.md, state.json, ROADMAP.md, config.json
...
- Initialize missing .gcd/ subdirectories
