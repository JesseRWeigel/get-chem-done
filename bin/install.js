 ...
 *
 * Usage:
 *   npx get-chem-done                  # Interactive
 *   npx get-chem-done --local          # Install into current project
 *   npx get-chem-done --global         # Install globally
 *   npx get-chem-done --uninstall      # Remove
 */
...
const BRAND = {
  name: "get-chem-done",
  displayName: "Get Chem Done",
  prefix: "gcd",
  pyModule: "gcd",
  homeDir: ".gcd",
  homeDirEnv: "GCD_HOME",
  description: "AI copilot for autonomous computational chemistry research",
  repo: "https://github.com/JesseRWeigel/get-chem-done",
};
